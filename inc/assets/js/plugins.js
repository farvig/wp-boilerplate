...
/* http://prismjs.com/download.html?themes=prism-dark&languages=markup+css+clike+javascript+php&plugins=line-numbers */
...
(function( $ ){
    ...
    $(function(){
        ...
        if(isSet == ''){$('.cookie-text-container').fadeIn('fast');}
