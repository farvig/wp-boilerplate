...
include('inc/admin/dashboard-widgets.php');
...
function ivp_theme_add_editor_styles() {
    add_editor_style( 'ivp-editor-style.css' );
}
add_action( 'admin_init', 'ivp_theme_add_editor_styles' );
